...
/*  JAVASCRIPT TUTORIAL ========================================================
    ...
    Not writing Javascript? Open tutorials for other languages by running the
    following commands from the command palette:

    * For Python, run       "Kite: Python Tutorial"
...
/*  CODE COMPLETIONS ===========================================================
    ...
    Let's write out an import statement for React.

    • Put your cursor at the end of the line marked with "<--".
    • Type "R" here for completions to help you finish this import statement:

    import React, { Component } from 'react';
*/


import     // <-- type a space and "R"


/*
    Kite's Line-of-Code completions can predict multiple words ahead of what
    you're going to type next. They show up after a space as well, without
    you typing anything.
*/
...
/*  CODE COMPLETIONS ON DEMAND =================================================
    ...
    Let's declare a class "Button" that extends "Component"

    • Put your cursor at the end of the line marked with "<--".
    • Press ctrl+space to request code completions.
    • Look for the completion with a line break icon. Text after this icon is
    inserted on the line below.

    Start off your class like this:
...
class Button extends C     // <-- press ctrl+space after "C"


/*
    Kite's Multi-line completions recognize that a line break is suitable and
    starts writing your next line of code.
*/
...
/*  That's it!
    ...
    "Kite: Javascript Tutorial" from the command palette.
    ...
    We love hearing from you! Visit https://github.com/kiteco/issue-tracker at
