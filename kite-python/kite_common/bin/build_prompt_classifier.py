...
import kite.promptclassifier.svm as prompt
...
def main():
    ...
    most_freq_words = utils.compute_most_freq_words(
        pos_files +
        neg_files,
        prompt.N_TOP_FREQ_WORDS)
    featurizer = prompt.PromptFeaturizer(most_freq_words=most_freq_words)
    ...
    feat_data = {
        ...
        'size_char_hash_vec': prompt.SIZE_CHAR_HASH_VEC,
        'size_word_hash_vec': prompt.SIZE_WORD_HASH_VEC
    }
