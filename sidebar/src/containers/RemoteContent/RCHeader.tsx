...
class RCHeader extends React.Component<RCHeaderProps> {
  render() {
    const item = this.props.remotecontent.dashboard_header
...
export default connect(mapStateToProps, null)(RCHeader)
