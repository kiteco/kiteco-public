...
!ifndef SERVICELIB
  ...
  !macro FUNC_SERVICE UN
    ...
    StrCpy $0 "false"
    System::Call 'advapi32::OpenSCManager(n, n, i ${SC_MANAGER_ALL_ACCESS}) i.r4'
    IntCmp $4 0 lbl_done
    StrCmp $3 "create" lbl_create
    System::Call 'advapi32::OpenService(i r4, t r2, i ${SERVICE_ALL_ACCESS}) i.r5'
    IntCmp $5 0 lbl_done
    ...
    lbl_create:
      ...
      System::Call 'advapi32::CreateService(i r4, t r2, t R7, i ${SERVICE_ALL_ACCESS}, \
                                             i R4, i R5, i 0, t R6, n, n, $R1, $R2, $R3) i.r6' 
 
      ; write description of service (SERVICE_CONFIG_DESCRIPTION)
      System::Call 'advapi32::ChangeServiceConfig2(ir6,i1,*t "$R8")i.R7'
    ...
    ; start service
    lbl_start:
      System::Call 'advapi32::StartService(i r5, i 0, i 0) i.r6'
      StrCmp $6 0 lbl_done lbl_good
